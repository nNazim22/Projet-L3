                ...
                <?php if (isset($_POST['ShowUpdateForm']) && $_POST['updateClientID'] == $user['ClientID']) : ?>
                  ...
                  <tr>
                    <form action="GestionClient.php" method="post">
                      <td><input class="inp" type="hidden" name="updateClientID" value="<?= $user['ClientID'] ?>"></td>
                      <td><input class="inp" type="text" name="updatedNom" value="<?= $user['Nom'] ?>" required></td>
                      <td><input class="inp" type="text" name="updatedPrenom" value="<?= $user['Prenom'] ?>" required></td>
                      <td><input class="inp" class="inp" type="date" name="updateddate_de_naissance" value="<?= $user['date_de_naissance'] ?>" required></td>
                      <td><input class="inp" type="email" name="updatedemail" value="<?= $user['email'] ?>" required></td>
                      <td><input class="inp" type="number" name="updatednmrtlfn" value="<?= $user['numero_tlphn'] ?>" required></td>
                      <td>
                        <select class="inp" name="updatedgenre" required>
